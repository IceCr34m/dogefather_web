...
def home_view(request):
    ...
    dagefather_data = TokenData.objects.get(symbol='DOGEFATHER')

    pancake_price = dagefather_data.current_price
    ...
    market_cap = str(round(float(dagefather_data.market_cap)))
    price = {"prefix": zeros,
             "suffix":  price_suffix,
